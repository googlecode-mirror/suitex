...
4. Make the `/wp-content/plugins/winex/winex.contents` writable by the webserver.  The easiest method is
to use your FTP client to CHMOD the file to 666 or world-writable.
